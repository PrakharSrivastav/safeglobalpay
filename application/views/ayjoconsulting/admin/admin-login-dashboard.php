        ...
        <table class="table table-bordered table-condensed">
            ...
            <tbody>
                <?php if ($result !== false) { ?>
                    ...
                    <td><?= html_escape($record['v_percent']); ?></td>
                    <td><?= html_escape($record['v_rolling_res']); ?></td>
                    <td><?= html_escape($record['v_rolling_res_duration']) . " Months"; ?></td>
                    <td><?= html_escape($record['v_refund_penalty']); ?></td>
                    <td><?= html_escape($record['v_chargeback_penalty']); ?></td>
                    <td><?= html_escape($pay_term); ?></td>
                    <td><?= html_escape($record['v_initial_reserve']); ?></td>
