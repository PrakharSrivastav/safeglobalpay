...
// 							
                        ...
                        <tr>
                            ...
                            <td><?= html_escape($record['c_contact']); ?></td>
                            <td><?= html_escape($record['c_alt_contact']); ?></td>
                            <!--<td><?php //echo html_escape($record['c_amount']); ?></td>-->
                            <td><?= html_escape($record['c_service']); ?></td>
                            <td><?= html_escape($record['c_description']); ?></td>
                        </tr>
                    <?php endforeach; ?>
<?php } ?>
            </tbody>
